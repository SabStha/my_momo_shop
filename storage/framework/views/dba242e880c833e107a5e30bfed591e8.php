    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <form id="paymentForm">
                ...
                <input type="hidden" name="branch_id" value="<?php echo e(session('selected_branch_id', 1)); ?>">
...
</script> <?php /**PATH C:\Users\sabst\momo_shop\resources\views/admin/payments/partials/payment-modal.blade.php ENDPATH**/ ?>