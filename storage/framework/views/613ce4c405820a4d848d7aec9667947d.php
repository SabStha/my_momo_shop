    ...
    <div class="pt-[50px] px-4 pb-20 space-y-16 max-w-5xl mx-auto">
        ...
        <div class="flex flex-row items-center gap-6">
            ...
            <div class="w-1/2 flex justify-start">
                <img src="<?php echo e(asset('storage/products/combos/group-combo.jpg')); ?>"
                     alt="Group Combo"
        ...
        <div class="flex flex-row-reverse items-center gap-6">
            ...
            <div class="w-1/2 flex justify-end">
                <img src="<?php echo e(asset('storage/products/combos/family-set.jpg')); ?>"
                     alt="Family Set"
                     class="w-36 sm:w-48 md:w-56 lg:w-64 rounded-xl shadow-md hover:scale-105 transition duration-300">
            </div>
        </div>
        ...
        <div class="flex flex-row items-center gap-6">
            ...
            <div class="w-1/2 flex justify-start">
                <img src="<?php echo e(asset('storage/products/combos/party-set.jpg')); ?>"
                     alt="Party Set"
                     class="w-36 sm:w-48 md:w-56 lg:w-64 rounded-xl shadow-md hover:scale-105 transition duration-300">
            </div>
        </div>
        ...
        <div class="flex flex-row-reverse items-center gap-6">
            ...
            <div class="w-1/2 flex justify-end">
                <img src="<?php echo e(asset('storage/products/combos/student-set.jpg')); ?>"
                     alt="Student Set"
                     class="w-36 sm:w-48 md:w-56 lg:w-64 rounded-xl shadow-md hover:scale-105 transition duration-300">
            </div>
        </div>
        ...
        <div class="flex flex-row items-center gap-6">
            ...
            <div class="w-1/2 flex justify-start">
                <img src="<?php echo e(asset('storage/products/combos/office-worker-set.jpg')); ?>"
...
<?php /**PATH C:\Users\evanh\my_momo_shop\resources\views/menu/combo.blade.php ENDPATH**/ ?>