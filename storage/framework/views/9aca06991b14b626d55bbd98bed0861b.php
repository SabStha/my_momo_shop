        ...
        <?php $__empty_1 = true; $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex justify-between items-start mb-4">
                    <div>
                        <h2 class="text-xl font-semibold text-gray-800"><?php echo e($branch->name); ?></h2>
                        <p class="text-gray-600">Code: <?php echo e($branch->code); ?></p>
                    </div>
                    <span class="px-2 py-1 text-sm rounded-full <?php echo e($branch->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                ...
                <div class="space-y-2 mb-4">
                    <p class="text-gray-600"><span class="font-medium">Address:</span> <?php echo e($branch->address); ?></p>
                    <p class="text-gray-600"><span class="font-medium">Contact:</span> <?php echo e($branch->contact_person); ?></p>
                    <p class="text-gray-600"><span class="font-medium">Email:</span> <?php echo e($branch->email); ?></p>
                    <p class="text-gray-600"><span class="font-medium">Phone:</span> <?php echo e($branch->phone); ?></p>
                </div>

                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div class="text-center p-2 bg-gray-50 rounded">
                        <p class="text-sm text-gray-600">Products</p>
                        <p class="text-lg font-semibold"><?php echo e($branch->products_count); ?></p>
                    </div>
                    <div class="text-center p-2 bg-gray-50 rounded">
                        <p class="text-sm text-gray-600">Orders</p>
                        <p class="text-lg font-semibold"><?php echo e($branch->orders_count); ?></p>
                    </div>
                    <div class="text-center p-2 bg-gray-50 rounded">
                        <p class="text-sm text-gray-600">Employees</p>
                        <p class="text-lg font-semibold"><?php echo e($branch->employees_count); ?></p>
                    </div>
                    <div class="text-center p-2 bg-gray-50 rounded">
                        <p class="text-sm text-gray-600">Tables</p>
                        <p class="text-lg font-semibold"><?php echo e($branch->tables_count); ?></p>
                    </div>
                </div>

                <div class="flex justify-between items-center">
                    <button onclick="switchToBranch(<?php echo e($branch->id); ?>)" class="text-blue-500 hover:text-blue-600">
                        View Dashboard
                    </button>
                    <div class="space-x-2">
                        <?php if($branch->id !== session('selected_branch_id')): ?>
                            <button onclick="showBranchSwitchModal(<?php echo e($branch->id); ?>, '<?php echo e(addslashes($branch->name)); ?>', <?php echo e($branch->requires_password ? 'true' : 'false'); ?>)"
                                class="text-indigo-600 hover:text-indigo-900">Switch to this branch</button>
                        <?php else: ?>
                            <span class="text-gray-500">Current branch</span>
                        <?php endif; ?>
                        <button onclick="showEditModal(<?php echo e($branch->id); ?>)" class="text-gray-600 hover:text-gray-800">
                            Edit
                        </button>
                        <button onclick="showDeleteModal(<?php echo e($branch->id); ?>)" class="text-red-500 hover:text-red-600">
                            Delete
                        </button>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\sabst\momo_shop\resources\views/admin/branches/index.blade.php ENDPATH**/ ?>