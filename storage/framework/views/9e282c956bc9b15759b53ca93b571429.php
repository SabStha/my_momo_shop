...
function findsData() {
    return {
        selectedModel: '<?php echo e($selectedModel ?? 'all'); ?>',
        merchandise: <?php echo json_encode($merchandise, 15, 512) ?>,
        loading: false,
        activeTab: 'tshirts',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\sabst\momo_shop\resources\views/finds/index.blade.php ENDPATH**/ ?>