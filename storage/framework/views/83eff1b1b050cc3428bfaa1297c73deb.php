        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <div class="d-flex gap-2">
                    <a href="<?php echo e(url('/test-panel?ref=creator123')); ?>" class="btn btn-primary">Test Valid Creator</a>
                    <a href="<?php echo e(url('/test-panel?ref=invalid123')); ?>" class="btn btn-warning">Test Invalid Creator</a>
                    <a href="<?php echo e(url('/test-panel')); ?>" class="btn btn-secondary">Clear Referral</a>
                </div>
            </div>
