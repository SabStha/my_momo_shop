<?php $__currentLoopData = $timeLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $logs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="card mb-4">
        <div class="card-header">
            <h4 class="card-title"><?php echo e(\Carbon\Carbon::parse($date)->format('F j, Y')); ?></h4>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($log->getTotalWorkHours()); ?></td>
                                <td><?php echo e($log->getBreakHours()); ?></td>
                                <td>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-primary edit-log" 
                                            ...
                                            data-clock-in="<?php echo e($log->clock_in->format('Y-m-d\TH:i:s')); ?>"
...
<?php $__env->stopPush(); ?> <?php /**PATH C:\Users\sabst\momo_shop\resources\views/admin/clock/_report.blade.php ENDPATH**/ ?>