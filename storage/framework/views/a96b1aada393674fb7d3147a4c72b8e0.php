                            ...
                            <div class="mt-4">
                                ...
                                <form action="<?php echo e(route('cart.add', $product)); ?>" method="POST" class="mb-2" id="addToCartForm">
                                    ...
                                    <div class="d-flex gap-2 mt-3">
                                        ...
                                        <button type="submit" formaction="<?php echo e(route('checkout.process', $product)); ?>" class="btn btn-success">Buy Now</button>
                                    </div>
                                </form>
...
function generateQRCode() {
    fetch(`<?php echo e(route('products.qr', $product)); ?>`)
        .then(response => response.json())
        .then(data => {
            if (data.success) {
...
function downloadQRCode() {
    ...
    if (qrCodeImage) {
        ...
        link.download = `product-${<?php echo json_encode($product->id, 15, 512) ?>}-qr-code.png`;
