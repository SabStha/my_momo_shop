        ...
        <div class="carousel slide" id="heroCarousel" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <picture>
                        <source srcset="<?php echo e(asset('storage/products/momo1.webp')); ?>" type="image/webp">
                        <img src="<?php echo e(asset('storage/products/momo1.jpg')); ?>" class="d-block w-100" alt="Momo 1" width="800" height="400" fetchpriority="high">
                    </picture>
                </div>
                <div class="carousel-item">
                    <img src="<?php echo e(asset('storage/products/momo2.jpg')); ?>" class="d-block w-100" alt="Momo 2" loading="lazy" width="800" height="400">
                </div>
                <div class="carousel-item">
                    <img src="<?php echo e(asset('storage/products/momo3.jpg')); ?>" class="d-block w-100" alt="Momo 3" loading="lazy" width="800" height="400">
                </div>
            </div>
            ...
            <div class="order-now">
                <?php if($featured): ?>
                    <form action="<?php echo e(route('checkout.buyNow', ['product' => $featured->id])); ?>" method="POST" id="orderNowForm">
                        <?php echo csrf_field(); ?>
            ...
            <div class="d-flex overflow-auto px-3 gap-4">
                ...
                <div class="card border-0 shadow-sm momo-card" data-tag="<?php echo e($product->tag); ?>"
                    ...
                    <div class="position-relative">
                        <img src="<?php echo e(asset('storage/' . $product->image)); ?>" class="card-img-top rounded-top" alt="<?php echo e($product->name); ?>" loading="lazy" width="220" height="220">
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="d-flex gap-1">
                            ...
                            <form action="<?php echo e(route('checkout.buyNow', ['product' => $product->id])); ?>" method="POST" class="flex-fill m-0 p-0">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="quantity" value="1">
...
<section id="page2">
    <div class="mb-4 text-center" data-aos="fade-up">
        ...
        <img src="<?php echo e(asset('storage/products/hotel.jpg')); ?>" class="d-block w-100" alt="Shop Image" loading="lazy" width="800" height="400">
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\sabst\momo_shop\resources\views/home.blade.php ENDPATH**/ ?>