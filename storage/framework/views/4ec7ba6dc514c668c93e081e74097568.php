    ...
    <div class="max-w-6xl mx-auto">
        <div class="bg-white/90 backdrop-blur-md rounded-2xl p-1 sm:p-2 md:p-4 shadow-xl">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6">
                <?php $__currentLoopData = $reviewsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-xl p-3 sm:p-6 shadow-lg">
                        <div class="flex items-center mb-2 sm:mb-4">
                        <div class="w-9 h-9 sm:w-12 sm:h-12 bg-gradient-to-br <?php echo e($review['color']); ?> rounded-full flex items-center justify-center text-white font-bold text-sm sm:text-base mr-2 sm:mr-3">
                            <?php echo e($review['avatar']); ?>

                        </div>
                            <div>
                            <div class="font-semibold text-sm sm:text-base text-gray-800"><?php echo e($review['name']); ?></div>
                    ...
                    <p class="text-gray-700 text-sm sm:text-base mb-2 sm:mb-4">"<?php echo e($review['comment']); ?>"</p>
                    <div class="text-xs sm:text-sm text-gray-500">Ordered: <?php echo e($review['order']); ?></div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            ...
            <div class="mt-0 mb-1 sm:mt-0 sm:mb-2 overflow-x-auto">
                <div class="grid grid-cols-3 gap-1 sm:gap-2 text-center">
                    <div class="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-1.5 sm:p-3">
                        <div class="text-xs sm:text-lg font-bold text-blue-600"><?php echo e($statistics['average_delivery_time'] ?? '25'); ?>min</div>
                            ...
                            <form id="review-form" class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div class="flex justify-center space-x-2 mb-2">
                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                            <button type="button" @click="selectedRating = <?php echo e($i); ?>" @mouseenter="hoverRating = <?php echo e($i); ?>" @mouseleave="hoverRating = 0" class="transform hover:scale-110 transition-all duration-200 focus:outline-none" :class="(selectedRating >= <?php echo e($i); ?> || hoverRating >= <?php echo e($i); ?>) ? 'text-yellow-400' : 'text-gray-300'">
            ...
            <?php else: ?>
            <div class="text-center mt-1 sm:mt-2">
                <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center gap-1 bg-[#6E0D25] text-white px-2 sm:px-3 py-1 sm:py-1.5 rounded-full font-semibold hover:bg-[#8B0D2F] transition-colors duration-300 text-[10px] sm:text-xs">
                    ✍️ Write a Review
                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                    </svg>
...
</section> <?php /**PATH C:\Users\sabst\momo_shop\resources\views/home/sections/customer-reviews.blade.php ENDPATH**/ ?>