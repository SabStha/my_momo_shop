...
<div id="desserts" class="relative bg-cover bg-center px-4 pb-20"
     style="background-image: url('<?php echo e(asset('storage/products/bg/2.png')); ?>');">
    ...
    <div class="relative z-10">
        ...
        <div class="grid grid-cols-2 items-center gap-4 mb-10">
            <div data-aos="fade-left">
                <img src="<?php echo e(asset('storage/products/desserts/browine-sundae.jpg')); ?>"
        ...
        <div class="grid grid-cols-2 items-center gap-4 mb-10">
            <div data-aos="fade-left">
                <img src="<?php echo e(asset('storage/products/desserts/waffles-icecream.jpg')); ?>"
                     class="rounded-xl shadow-lg w-full max-w-[240px] mx-auto hover:scale-105 transition duration-500"
        ...
        <div class="grid grid-cols-2 items-center gap-4 mb-10">
            <div data-aos="fade-left">
                <img src="<?php echo e(asset('storage/products/desserts/custom-icecream.jpg')); ?>"
                     class="rounded-xl shadow-lg w-full max-w-[240px] mx-auto hover:scale-105 transition duration-500"
...
<?php /**PATH C:\Users\evanh\my_momo_shop\resources\views/menu/desserts.blade.php ENDPATH**/ ?>