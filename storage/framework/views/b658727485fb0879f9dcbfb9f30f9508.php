    ...
    <div class="login-card" style="background-color: #fffaf3; border-radius: 20px; padding: 2rem 2.5rem; box-shadow: 0 10px 30px rgba(0,0,0,0.2); max-width: 400px; width: 100%;">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="name" id="name" class="form-control" required autofocus value="<?php echo e(old('name')); ?>">
            </div>
        ...
        <div class="text-center mt-4">
            ...
            <a href="<?php echo e(route('login')); ?>" style="color: #a04d1a; font-weight: bold;">Log in</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\sabst\momo_shop\resources\views/auth/register.blade.php ENDPATH**/ ?>