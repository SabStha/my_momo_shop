            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <form id="profile-picture-form" action="<?php echo e(route('profile.picture')); ?>" method="POST" enctype="multipart/form-data" class="hidden">
                            <?php echo csrf_field(); ?>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-between items-center py-3 border-b border-gray-200">
                            ...
                            <span class="text-sm text-gray-900">#<?php echo e($user->id); ?></span>
                        </div>
                        
                        <div class="flex justify-between items-center py-3 border-b border-gray-200">
                            <span class="text-sm font-medium text-gray-700">Phone Number</span>
                            <span class="text-sm text-gray-900"><?php echo e($user->phone ?: 'Not provided'); ?></span>
                        </div>
