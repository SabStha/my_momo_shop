...
<head>
    ...
    <title><?php echo e(config('app.name', 'Momo Admin')); ?></title>
...
<body class="h-full text-gray-800 font-sans antialiased">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <?php if(!request()->routeIs('admin.branches.index')): ?>
            <aside class="md:w-56 w-16 bg-indigo-900 text-white flex-shrink-0 flex flex-col" style="height: 100vh;">
                ...
                <nav class="p-2 md:p-4 space-y-1 flex-1 overflow-y-auto">
                    <?php $__currentLoopData = $nav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(isset($item['roles']) && !in_array(auth()->user()->roles->pluck('name')->first(), $item['roles'])): ?>
                            <?php continue; ?>
                        <?php endif; ?>
                        <?php if($item['needs_branch'] && !$currentBranch): ?>
                            <a href="<?php echo e(route('admin.branches.index')); ?>" 
                               class="flex items-center px-2 md:px-4 py-2 rounded text-sm transition hover:bg-indigo-800">
                                <i class="<?php echo e($item['icon']); ?> mr-0 md:mr-3 w-5"></i> <span class="hidden md:inline"><?php echo e($item['label']); ?></span>
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e($item['needs_branch'] ? route($item['route'], ['branch' => $currentBranch->id]) : route($item['route'])); ?>"
                               class="flex items-center px-2 md:px-4 py-2 rounded text-sm transition <?php echo e(request()->routeIs($item['route'].'*') ? 'bg-indigo-800' : 'hover:bg-indigo-800'); ?>">
                                <i class="<?php echo e($item['icon']); ?> mr-0 md:mr-3 w-5"></i> <span class="hidden md:inline"><?php echo e($item['label']); ?></span>
                            </a>
                        <?php endif; ?>
        ...
        <div class="flex-1 overflow-y-auto bg-white">
            ...
            <header class="bg-white shadow px-6 py-4">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-xl font-semibold"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h2>
                    ...
                    <div class="relative">
                        <?php if($currentBranch): ?>
                            <button type="button" 
                                    ...
                                    onclick="showBranchSwitchModal(<?php echo e($currentBranch->id); ?>, '<?php echo e(addslashes($currentBranch->name)); ?>', <?php echo e($currentBranch->requires_password ? 'true' : 'false'); ?>)">
                                <i class="fas fa-building text-indigo-500"></i>
                                <span class="text-sm truncate max-w-[140px]" data-branch-name><?php echo e($currentBranch->name); ?></span>
                    ...
                    <div class="p-4">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 w-0 flex-1">
                                ...
                                <p class="mt-1 text-sm text-yellow-700"><?php echo e(session('warning')); ?></p>
                            </div>
                            <div class="ml-4 flex-shrink-0 flex">
                    ...
                    <div class="p-4">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 w-0 flex-1">
                                ...
                                <p class="mt-1 text-sm text-blue-700"><?php echo e(session('info')); ?></p>
                            </div>
                            <div class="ml-4 flex-shrink-0 flex">
    ...
    <?php echo $__env->make('admin.branches.switch-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('admin.payments.partials.payment-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
