...
<?php $__env->startSection('title', 'Investor Management'); ?>
...
<div class="px-4 py-6 mx-auto max-w-7xl">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
        ...
        <a href="<?php echo e(route('admin.investors.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition duration-200">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <div class="bg-white rounded-lg shadow p-6 flex items-center">
            <div class="flex-1">
                ...
                <div class="text-3xl font-bold text-gray-900"><?php echo e($totalInvestors); ?></div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow p-6 flex items-center">
            <div class="flex-1">
                ...
                <div class="text-3xl font-bold text-gray-900"><?php echo e($activeInvestors); ?></div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow p-6 flex items-center">
            <div class="flex-1">
                ...
                <div class="text-3xl font-bold text-gray-900">Rs <?php echo e(number_format($totalInvestment, 2)); ?></div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow p-6 flex items-center">
            <div class="flex-1">
                ...
                <div class="text-3xl font-bold text-gray-900">Rs <?php echo e(number_format($totalPayouts, 2)); ?></div>
            </div>
        ...
        <div class="overflow-x-auto">
                        ...
                        <tr class="hover:bg-gray-50">
                                ...
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        <div class="h-10 w-10 rounded-full bg-blue-600 flex items-center justify-center">
                                            <span class="text-sm font-medium text-white"><?php echo e(strtoupper(substr($investor->name, 0, 1))); ?></span>
                                        </div>
                                    </div>
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900"><?php echo e($investor->name); ?></div>
                                        <div class="text-sm text-gray-500"><?php echo e($investor->email); ?></div>
                                        <?php if($investor->company_name): ?>
                                            <div class="text-xs text-gray-400"><?php echo e($investor->company_name); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full <?php echo e($investor->investment_type === 'individual' ? 'bg-blue-100 text-blue-800' :
                                    ($investor->investment_type === 'corporate' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800')); ?>">
                                    <?php echo e(ucfirst(str_replace('_', ' ', $investor->investment_type))); ?>

                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                Rs <?php echo e(number_format($investor->investments->sum('investment_amount'), 2)); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e(number_format($investor->investments->sum('ownership_percentage'), 2)); ?>%
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <a href="<?php echo e(route('admin.investors.show', $investor)); ?>" 
                                    ...
                                    <a href="<?php echo e(route('admin.investors.dashboard', $investor)); ?>" 
                                    ...
                                    <a href="<?php echo e(route('admin.investors.edit', $investor)); ?>" 
                                    ...
                                    <button type="button" 
                                            onclick="confirmDelete(<?php echo e($investor->id); ?>, '<?php echo e($investor->name); ?>')" 
            ...
            <?php else: ?>
                <div class="px-6 py-12 text-center">
                    ...
                    <div class="mt-6">
                        <a href="<?php echo e(route('admin.investors.create')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
...
<?php $__env->stopPush(); ?> 
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\sabst\momo_shop\resources\views/admin/investors/index.blade.php ENDPATH**/ ?>