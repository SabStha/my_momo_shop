...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('generatePWAQR').addEventListener('click', function (e) {
        e.preventDefault();
        fetch('<?php echo e(route("wallet.generate-pwa-qr")); ?>', {
            method: 'GET',
            headers: {
                'X-CSRF-TOKEN': token,
                'Accept': 'application/json'
    ...
    document.getElementById('productForm').addEventListener('submit', function (e) {
        ...
        fetch('<?php echo e(route("wallet.generate-product-qr")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': token,
    ...
    document.getElementById('orderForm').addEventListener('submit', function (e) {
        ...
        fetch(`<?php echo e(route("wallet.order-details")); ?>?user_id=${userId}`, {
            method: 'GET',
            headers: {
                'X-CSRF-TOKEN': token,
                'Accept': 'application/json'
...
<?php echo $__env->make('desktop.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\sabst\momo_shop\resources\views/desktop/wallet/qr-generator.blade.php ENDPATH**/ ?>