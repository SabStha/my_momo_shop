        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="<?php echo e(route('admin.inventory.create')); ?>" class="btn btn-success me-2">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td>
                                                <div class="form-check">
                                                    <input class="form-check-input item-checkbox" type="checkbox" 
                                                           ...
                                                           data-locked="<?php echo e($item->is_locked ? 'true' : 'false'); ?>"
                                                           <?php echo e(!$item->is_locked ? 'disabled' : ''); ?>>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <span class="badge bg-<?php echo e($item->status === 'active' ? 'success' : 'warning'); ?>">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <button type="button" 
                                                            class="btn <?php echo e($item->is_locked ? 'btn-warning' : 'btn-info'); ?> btn-sm lock-btn"
                                                            data-item-id="<?php echo e($item->id); ?>"
                                                            data-locked="<?php echo e($item->is_locked ? 'true' : 'false'); ?>">
                                                        <i class="fas fa-<?php echo e($item->is_locked ? 'unlock' : 'lock'); ?>"></i>
                                                    </button>
                                                    <form action="<?php echo e(route('admin.inventory.destroy', $item)); ?>" 
                                                          method="POST" 
                                                          class="d-inline"
...
function proceedToOrder() {
    ...
    // Submit the order
    fetch("<?php echo e(route('admin.supply.orders.store')); ?>", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': token,
    ...
    .then(data => {
        if (data.success) {
            ...
            window.location.href = "<?php echo e(route('admin.supply.orders.index')); ?>";
        } else {
...
<?php echo $__env->make('desktop.admin.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\sabst\momo_shop\resources\views/desktop/admin/inventory/manage.blade.php ENDPATH**/ ?>