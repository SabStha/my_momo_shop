...
<div id="paymentModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden overflow-y-auto h-full w-full z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <form id="paymentModalsForm">
                <input type="hidden" id="paymentModalsOrderIdInput" name="order_id">
                <input type="hidden" name="branch_id" value="{{ session('selected_branch_id', 1) }}">
                
                <div class="mb-4">
                    <label for="paymentModalsMethod" class="block text-sm font-medium text-gray-700 mb-2">Payment Method</label>
                    <select class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" id="paymentModalsMethod" name="payment_method" required>
                ...
                <div id="paymentModalsCashFields" class="space-y-4" style="display: none;">
                    <div>
                ...
                <div id="paymentModalsCardFields" style="display: none;">
                    <div class="mb-4">
                ...
                <div id="paymentModalsWalletFields" class="space-y-4" style="display: none;">
                    <div>
...
document.getElementById('paymentModalsMethod').addEventListener('change', function() {
    const method = this.value;
    document.getElementById('paymentModalsCashFields').style.display = method === 'cash' ? 'block' : 'none';
    document.getElementById('paymentModalsCardFields').style.display = method === 'card' ? 'block' : 'none';
    document.getElementById('paymentModalsWalletFields').style.display = method === 'wallet' ? 'block' : 'none';
});
...
function submitPayment() {
    ...
    let form = document.getElementById('paymentModalsForm');
...
function processPayment(orderId) {
    document.getElementById('paymentModalsOrderIdInput').value = orderId;
