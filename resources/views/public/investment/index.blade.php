        ...
        <div class="bg-white rounded-xl md:rounded-2xl shadow-xl p-4 md:p-8 mb-6 md:mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6 mb-4 md:mb-8">
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg md:rounded-xl shadow-lg p-3 md:p-6 text-center text-white">
                    <div class="text-xl md:text-3xl font-bold">{{ $stats['total_investors'] ?? 0 }}</div>
                ...
                <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-lg md:rounded-xl shadow-lg p-3 md:p-6 text-center text-white">
                    <div class="text-lg md:text-3xl font-bold">₹{{ number_format($stats['total_invested'] ?? 0) }}</div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="{{ $rowColor }} transition-colors">
                                    <td class="px-2 md:px-6 py-2 md:py-4 whitespace-nowrap">
                                        <div class="text-xs md:text-sm font-medium text-gray-900">{{ $serialNumber }}</div>
                                    </td>
                                    <td class="px-2 md:px-6 py-2 md:py-4 whitespace-nowrap">
                                        <div class="text-xs md:text-sm font-medium text-gray-900">{{ $investor->name ?? $investor->full_name ?? 'N/A' }}</div>
                                    </td>
                                    <td class="px-2 md:px-6 py-2 md:py-4">
                                        <div class="text-xs md:text-sm text-gray-900">{{ $investor->address ?? 'N/A' }}</div>
                                    </td>
                                    <td class="px-2 md:px-6 py-2 md:py-4 whitespace-nowrap">
                                        <div class="text-xs md:text-sm font-medium text-gray-900">₹{{ number_format($investor->investment_amount ?? $investor->amount ?? $investor->total_invested ?? 0) }}</div>
                                    </td>
                                    <td class="px-2 md:px-6 py-2 md:py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-2 md:px-6 py-2 md:py-4 whitespace-nowrap">
                                        <div class="text-xs md:text-sm text-gray-900" style="filter: blur(2px); opacity: 1;">{{ $investor->email ?? 'N/A' }}</div>
                                    </td>
                                    <td class="px-2 md:px-6 py-2 md:py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center px-1.5 md:px-2.5 py-0.5 rounded-full text-xs font-medium {{ $likelihoodColors[$likelihood] }}">
                                            {{ $likelihood }}/5
                                        </span>
                                    </td>
                                </tr>
                    ...
                    <div class="mb-4 md:mb-6">
                        ...
                        <div class="flex items-center gap-1 md:gap-2">
                            @for ($i = 1; $i <= 5; $i++)
                                ...
                                <label for="likelihood-{{ $i }}" class="text-2xl md:text-3xl cursor-pointer text-gray-300 hover:text-yellow-400 transition-all duration-300 hover:scale-125 star-label" data-value="{{ $i }}">
                                    ★
                                </label>
                            @endfor
                        </div>
