<div class="bg-[#F9F6F3] min-h-screen overflow-x-hidden">
    <div class="w-full px-4 py-4 space-y-8 overflow-x-hidden">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-sm sm:text-base text-gray-600">Refreshing beverages - from hot drinks to cold refreshments</p>
        </div>
        ...
        <div class="space-y-4">
            <div class="flex items-center gap-3 mb-4">
                ...
                <h2 class="text-xl font-bold text-[#6E0D25]">Hot Drinks</h2>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                @foreach($hotDrinks as $product)
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 drink-card touch-ripple card-animate">
        ...
        <div class="space-y-4">
            <div class="flex items-center gap-3 mb-4">
                <div class="text-2xl">🥤</div>
                <h2 class="text-xl font-bold text-[#6E0D25]">Cold Drinks</h2>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div class="space-y-4">
            <div class="flex items-center gap-3 mb-4">
                <div class="text-2xl">🧋</div>
                <h2 class="text-xl font-bold text-[#6E0D25]">Boba Drinks</h2>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        @if($drinks && $drinks->count() > 0 && !$hotDrinks && !$coldDrinks && !$bobaDrinks)
        <!-- GENERAL DRINKS SECTION -->
        <div class="space-y-4">
            <div class="flex items-center gap-3 mb-4">
                <div class="text-2xl">🥤</div>
                <h2 class="text-xl font-bold text-[#6E0D25]">Drinks</h2>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Drink card entrance animations
