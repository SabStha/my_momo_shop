            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    <div class="flex-1">
                        ...
                        <div class="text-2xl font-bold text-gray-900">Rs {{ number_format($investments->sum('investment_amount'), 2) }}</div>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    <div class="flex-1">
                        ...
                        <div class="text-2xl font-bold text-gray-900">{{ number_format($investments->sum('ownership_percentage'), 2) }}%</div>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    <div class="flex-1">
                        ...
                        <div class="text-2xl font-bold text-gray-900">{{ $investments->where('status', 'active')->count() }}</div>
                    </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">{{ $investment->branch->name }}</div>
                                    <div class="text-sm text-gray-500">{{ $investment->branch->location }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    Rs {{ number_format($investment->investment_amount, 2) }}
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    {{ number_format($investment->ownership_percentage, 2) }}%
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
