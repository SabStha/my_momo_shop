                    ...
                    <form action="{{ route('investor.profile.update') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ $investor->name }}" readonly
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" value="{{ $investor->email }}" readonly
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-50 text-gray-500">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="investment_type" id="investment_type" value="{{ ucfirst(str_replace('_', ' ', $investor->investment_type)) }}" readonly
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-50 text-gray-500">
                            </div>
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="address" id="address" rows="3"
                                      ...
                                      placeholder="Enter your address">{{ old('address', $investor->address) }}</textarea>
                            @error('address')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            <div>
                                ...
                                <input type="text" name="company_name" id="company_name" value="{{ $investor->company_name }}" readonly
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-50 text-gray-500">
                            </div>
                            
                            <div>
                                <label for="company_registration" class="block text-sm font-medium text-gray-700 mb-2">Company Registration</label>
                                <input type="text" name="company_registration" id="company_registration" value="{{ $investor->company_registration }}" readonly
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-50 text-gray-500">
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="notes" id="notes" rows="3"
                                      ...
                                      placeholder="Any additional notes">{{ old('notes', $investor->notes) }}</textarea>
                            @error('notes')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="p-6">
                    <div class="space-y-6">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-lg font-semibold text-gray-900">Rs {{ number_format($investor->investments->sum('investment_amount'), 2) }}</span>
                        </div>
                        
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-500">Total Ownership</span>
                            <span class="text-lg font-semibold text-gray-900">{{ number_format($investor->investments->sum('ownership_percentage'), 2) }}%</span>
                        </div>
                        
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-500">Total Payouts</span>
                            <span class="text-lg font-semibold text-green-600">Rs {{ number_format($investor->payouts->sum('amount'), 2) }}</span>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm text-gray-900">{{ $investor->created_at->format('M d, Y') }}</span>
                        </div>
                    </div>
