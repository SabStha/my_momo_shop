...
<div class="px-4 py-6 mx-auto max-w-4xl">
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">Create a new investor account and investment details</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <form action="{{ route('admin.investors.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="border-t border-gray-200 pt-6 mb-6">
                ...
                <p class="text-sm text-gray-600 mb-4">Set login credentials for the investor dashboard</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <select name="investment_type" id="investment_type" required
                        ...
                        <option value="individual" {{ old('investment_type') == 'individual' ? 'selected' : '' }}>Individual</option>
                        <option value="corporate" {{ old('investment_type') == 'corporate' ? 'selected' : '' }}>Corporate</option>
            ...
            <div id="companyFields" class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6" style="display: none;">
                ...
                <div>
                    ...
                    <input type="text" name="company_registration" id="company_registration" value="{{ old('company_registration') }}"
            ...
            <div class="border-t border-gray-200 pt-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="number" name="investment_amount" id="investment_amount" value="{{ old('investment_amount') }}" step="0.01" required
                    ...
                    <div>
                        ...
                        <input type="number" name="ownership_percentage" id="ownership_percentage" value="{{ old('ownership_percentage') }}" step="0.01" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="date" name="investment_date" id="investment_date" value="{{ old('investment_date') }}" required
            ...
            <div class="border-t border-gray-200 pt-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="branch_ownership_percentage" id="branch_ownership_percentage" value="{{ old('branch_ownership_percentage') }}" step="0.01" required
            ...
            <div class="border-t border-gray-200 pt-6 mb-6">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="notes" id="notes" rows="4"
                              ...
                              placeholder="Any additional notes about this investor">{{ old('notes') }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
