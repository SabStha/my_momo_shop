...
<div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p class="mt-2 text-center text-sm text-gray-600">
            Enter your password to access wallet management
        </p>
    </div>
                ...
                <div>
                    ...
                    <div class="mt-1 relative">
                        <input type="password" 
                               ...
                               required 
                               autofocus
                               class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('password') border-red-300 text-red-900 placeholder-red-300 focus:ring-red-500 focus:border-red-500 @enderror"
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 text-center">
                    <p class="text-xs text-gray-500">
                        This authentication is required for wallet management operations
                    </p>
                </div>
            </div>
        </div>
