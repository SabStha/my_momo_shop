        ...
        <div class="px-3 py-2 border-b bg-white relative z-50">
            <div class="flex items-center justify-between">
                <div class="flex space-x-1">
                    <button onclick="setOrderMethod('dine-in')" id="dineInBtn" class="order-method-btn active px-2 py-0.5 text-xs rounded-full bg-blue-600 text-white hover:bg-blue-700">
                        Dine In
                    </button>
                    <button onclick="setOrderMethod('takeaway')" id="takeawayBtn" class="order-method-btn px-2 py-0.5 text-xs rounded-full bg-gray-200 text-gray-700 hover:bg-gray-300">
                        Takeaway
                    </button>
                </div>
                <!-- Table Selection (initially hidden) -->
                <div id="tableSelection" class="flex items-center space-x-1">
